...
public class AreaConsequValueIdentity extends HeaderIdentity {
     ...
     * @param upperMin inclusive if higher Minimum difference of ranking
     * @param upperMax inclusive if higher Maximum difference of ranking
     * @param lowerMin inclusive if lower Minimum difference of ranking
     * @param lowerMax inclusive if lower Maximum difference of ranking
     * @param negate boolean if it should negate the behaviour
     * @param val value of this identity
     */
    public AreaConsequValueIdentity(PositionInGrid pos, int upperMin, int upperMax, int lowerMin, int lowerMax, boolean negate, String val) {
        super("");
        this.pos = pos;
        ...
        this.name = pos.toString() +" | "+boundaries[1][1]+":"+boundaries[1][0]+(negate?"!":"")+"~"+boundaries[0][0]+":"+boundaries[0][1]+" | "+val;
        this.val = val;
        this.negate = negate;
    }
    @Override
    ...
    public boolean match(PosValueIdentity toCheck) {
        ...
        return  (negate && (boundaries[upper][1]<associateIntDiff || boundaries[upper][0]>associateIntDiff)) ||
